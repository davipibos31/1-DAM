...
namespace Prueba2
{
    class Program
    {
        ...
        {
            int primero = 0, primero1 = 0, resultado = primero1; char operacion = '0'; bool simbolo = true; int cont = 10; char[] save_ope = new char[cont];
            do
            {
                do {
                    try
                    {
                        ...
                        primero1 = Convert.ToInt32(Console.ReadLine()); resultado = primero1;
                        simbolo = false;

...
namespace Prueba2
{
    class Program
    {
        ...
        {
            int primero = 0, resultado = 0, primero1 = 0; char operacion = '0'; bool simbolo = true;
            do
            {
                do {
                    try
                    {
                        ...
                        primero1 = Convert.ToInt32(Console.ReadLine());
                        simbolo = false;
                    ...
                    do
                    {
                        ...
                        switch (operacion)                                                                                  //Un switch con cada caso posible de operaciones +,-,*,/
                        {
                            ...
                            case '-':
                                ...
                                resultado = resultado - (primero - primero1); primero1 = 0;
                                break;
                            case '*':
                                do
                                {
